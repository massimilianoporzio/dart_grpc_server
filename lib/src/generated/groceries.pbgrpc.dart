...
class GroceriesServiceClient extends $grpc.Client {
  ...
  static final _$deleteCategory = $grpc.ClientMethod<$0.Category, $0.Category>(
      ...
      ($0.Category value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.Category.fromBuffer(value));
  static final _$getAllItemsByCategory =
      $grpc.ClientMethod<$0.Category, $0.AllItemsOfCategory>(
          '/GroceriesService/getAllItemsByCategory',
          ($0.Category value) => value.writeToBuffer(),
  ...
  $grpc.ResponseFuture<$0.AllItemsOfCategory> getAllItemsByCategory(
      $0.Category request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$getAllItemsByCategory, request, options: options);
  }
}
...
abstract class GroceriesServiceBase extends $grpc.Service {
  ...
  $async.Future<$0.AllItemsOfCategory> getAllItemsByCategory_Pre(
      $grpc.ServiceCall call, $async.Future<$0.Category> request) async {
    return getAllItemsByCategory(call, await request);
  }
  ...
  $async.Future<$0.Category> deleteCategory(
      $grpc.ServiceCall call, $0.Category request);
  $async.Future<$0.AllItemsOfCategory> getAllItemsByCategory(
      $grpc.ServiceCall call, $0.Category request);
}
